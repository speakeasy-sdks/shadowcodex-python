...
class AdminTeamsSettingsSetNameApplicationJSON:
    ...
    r"""The new name of the workspace."""
    team_id: str = dataclasses.field(metadata={'dataclasses_json': { 'letter_case': utils.get_field_name('team_id') }})
    r"""ID for the workspace to set the name for."""
    

@dataclasses.dataclass
class AdminTeamsSettingsSetNameRequest:
    
    request_body: AdminTeamsSettingsSetNameApplicationJSON = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
