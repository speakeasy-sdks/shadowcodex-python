...
class FilesSharedPublicURLRequest:
    ...
    request_body: Optional[FilesSharedPublicURLApplicationJSON] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class FilesSharedPublicURLResponse:
    ...
    files_shared_public_url_error_schema: Optional[dict[str, dict[str, Any]]] = dataclasses.field(default=None)
    r"""Typical error response"""
    files_shared_public_url_schema: Optional[dict[str, dict[str, Any]]] = dataclasses.field(default=None)
