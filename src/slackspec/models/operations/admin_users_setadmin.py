...
class AdminUsersSetAdminApplicationJSON:
    ...
    r"""The ID of the user to designate as an admin."""
    

@dataclasses.dataclass
class AdminUsersSetAdminRequest:
    
    request_body: AdminUsersSetAdminApplicationJSON = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
