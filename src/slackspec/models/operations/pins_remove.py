...
class PinsRemoveApplicationJSON:
    ...
    r"""Channel where the item is pinned to."""
    ...
    r"""Timestamp of the message to un-pin."""
    

@dataclasses.dataclass
class PinsRemoveRequest:
    
    request_body: PinsRemoveApplicationJSON = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
...
class PinsRemoveResponse:
    ...
    pins_remove_error_schema: Optional[dict[str, dict[str, Any]]] = dataclasses.field(default=None)
    r"""Typical error response"""
    pins_remove_schema: Optional[dict[str, dict[str, Any]]] = dataclasses.field(default=None)
