...
class StarsListRequest:
    ...
    r"""Authentication token. Requires scope: `stars:read`"""
...
class StarsListResponse:
    ...
    stars_list_error_schema: Optional[dict[str, dict[str, Any]]] = dataclasses.field(default=None)
    r"""Typical error response"""
    stars_list_schema: Optional[dict[str, dict[str, Any]]] = dataclasses.field(default=None)
