...
class CallsParticipantsRemoveApplicationJSON:
    ...
    r"""The list of users to remove as participants in the Call. [Read more on how to specify users here](/apis/calls#users)."""
    

@dataclasses.dataclass
class CallsParticipantsRemoveRequest:
    
    request_body: CallsParticipantsRemoveApplicationJSON = dataclasses.field(metadata={'request': { 'media_type': 'application/json' }})
